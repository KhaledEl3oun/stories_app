...
void setupFirebaseMessagingListener() {
  FirebaseMessaging.onMessage.listen((RemoteMessage message) {
    print("📩 إشعار مستلم أثناء تشغيل التطبيق: ${message.notification?.title} - ${message.notification?.body}");
          ...
          child: AppPadding(
            child: Column(
              ...
              children: [
                ...
                AppBarCustom(title: ' $userNameمرحبا بك',scaffoldKey: _scaffoldKey,),
  ...
  builder: (context, state) {
    ...
    if (state is CategoryLoading) {
      ...
      return Center(
        ...
        print("🟢 الفئات في BlocBuilder: ${state.categories.map((c) => c.name).toList()}"); // ✅ طباعة الفئات داخل `BlocBuilder`
      ...
      return Column(
        ...
        children: [
          ...
          if (state.categories.isEmpty)
            ...
            SizedBox(
              height: 140, // ✅ تأكد من تحديد ارتفاع لـ `ListView`
              child: ListView.builder(
                scrollDirection: Axis.horizontal,
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  ...
                                  onError: (exception, stackTrace) {
                                    print("❌ فشل تحميل صورة الفئة: ${category.image}");
                                  },
                                ),
                              ),
                            ),
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            ...
                            fit: BoxFit.cover,
                            onError: (exception, stackTrace) {
                              print("❌ فشل تحميل صورة القصة: ${story.imageCover}");
                            },
                          ),
                        ),
                      ),
